...
public class ResponseBuilder {
    ...
    public static<T> ResponseEntity<SimpleErrorResponse>  error( HttpStatus status ,String message  ) {
    ...
    public static ResponseEntity<FieldErrorResponse>  error(HttpStatus status , String message , List<FieldErrorResponse.CustomFieldError> error) {
